...
class RoutesResolver {
    constructor(container, config, injector) {
        ...
        this.routerBuilder = new router_explorer_1.RouterExplorer(metadataScanner, this.container, this.injector, this.routerProxy, this.routerExceptionsFilter, this.config);
    }
    ...
    registerRouters(routes, moduleName, basePath, applicationRef) {
        routes.forEach(instanceWrapper => {
            ...
            this.routerBuilder.explore(instanceWrapper, moduleName, applicationRef, path);
        });
    }
